			...
			<!--Nav bar-->
				<nav class="navbar navbar-expand-lg navbar-dark bg-primary">
					  ...
					  <div class="addform" >
                      	...
                      	<form class="form-horizontal" action="./Saveinvoiceservlet" method="post">
                      	
                      	
                      		<div class="form-group">
								  <label class="control-label col-sm-2" for="innum">Invoice Number:</label>
								  <div class="col-sm-10">
									<input type="text" name="invoicenumber"class="form-control" id="innum">
								  </div>
								...
								<div class="form-group">
										...
										<div class="col-sm-10">
										  <input type="text" name="medicinename"class="form-control" id="Medname">
										</div>
									  </div>
