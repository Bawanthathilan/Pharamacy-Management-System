...
<%@page import="supReports.DBSupConnector"%>
...
try
{
    ...
    conn= DBSupConnector.getConnection();
    String query = "select * from newsupplier";          //Fetching data from table
