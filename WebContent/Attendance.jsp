		...
		<div class="main-content">
			<!--Nav bar-->
				<nav class="navbar navbar-expand-lg navbar-dark bg-primary">
						...
						<div class="collapse navbar-collapse" id="navbarNav">
						  <ul class="navbar-nav">
							...
							<li class="nav-item active">
							  <a class="nav-link" href="Attendance.jsp">Mark Attendance <span class="sr-only">(current)</span></a>
							</li>
							<li class="nav-item">
					  ...
					  <div class="addform" >
							<form class="form-horizontal" action="AtServlet" method="post">
								<div class="form-group">
								  <label class="control-label col-sm-2" for="email">Employee ID :</label>
								  <div class="col-sm-10">
						
									<input type="text" name= "Eid" placeholder="ID" class="form-control" id="Eid" >
								  </div>
								</div>
								
								<div class="form-group">
								  <label class="control-label col-sm-2" for="pwd">Mark Today's Date :</label>
								  <div class="col-sm-10">
									<input type="date" name="AtDate" class="form-control" id="pwd">
								  </div>
								  </div>
