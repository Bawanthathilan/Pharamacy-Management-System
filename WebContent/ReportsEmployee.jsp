					  ...
					  <div class="addform" >
							<form class="form-horizontal" action="./SaveServlet" method="post">
								<div class="form-group">
									   <br><p> <B> Choose Report Type : </B> </p>
								 </div>
									<div class="form-group">
										 
										<div class="col-sm-10">
										<button type="submit" data-toggle="modal" data-target="#exampleModal" class="btn btn-primary">Employee Payments</button>
										</div>
									  </div>
									  <div class="form-group">
										 
										<div class="col-sm-10">
										<button type="submit" data-toggle="modal" data-target="#exampleModal" class="btn btn-primary">Attendance   </button>
										</div>
									  </div>
									  <div class="form-group">
										 
										<div class="col-sm-10">
										<button type="submit" data-toggle="modal" data-target="#exampleModal" class="btn btn-primary">Leave</button>
										</div>
									  </div>
