					  ...
					  <!--Nav bar end-->
							...
							<div class="addform" >
									<form class="form-horizontal" action="#">
										...
										<div class="form-group">
										  <label class="control-label col-sm-2" for="pwd">Supplier ID <Title></Title>:</label>
										  <div class="col-sm-8">
										...
										<div class="form-group">
												<button type="submit" class="btn btn-primary"><a href ="pdfGenSupplier.jsp" style ="color:white;">Download</button>
										</div>
