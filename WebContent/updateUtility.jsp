...
<%@page import="java.sql.Connection"%>
		...
		<%
			...
			String database = "luckylandsystem";
			String userid = "root";
		...
		<div class="main-content">
			<!--Nav bar-->
				<nav class="navbar navbar-expand-lg navbar-dark bg-primary">
					  ...
					  <div class="addform" >
							<form class="form-horizontal" action="updateProcessUtility.jsp" method="post">
								<div class="form-group">
								  <label class="control-label col-sm-2" for="pwd">Utility ID:</label>
								  <div class="col-sm-10">
									<input type="text" name="utilityID" class="form-control" id="id" value="<%=resultSet.getInt("utilityID") %>" >
								  </div>
								</div>
								<div class="form-group col-md-4">
									<label for="inputState">Utility Type:</label>
									<select id="uType" name="utype" class="form-control"  value="<%=resultSet.getString("utype") %>">
								...
								<div class="form-group col-md-4">
									<label for="inputState">Payment Method:</label>
										<select id="umethod" name="method" class="form-control"  value="<%=resultSet.getString("method") %>">
										  <option selected>Choose...</option>
										  <option>Cash</option>
