				...
				<nav class="navbar navbar-expand-lg navbar-dark bg-primary">
						...
						<div class="collapse navbar-collapse" id="navbarNav">
						  <ul class="navbar-nav">
							...
							<li class="nav-item">
							  <a class="nav-link" href="viewExpenses.jsp">Expenses<span class="sr-only">(current)</span></a>
							</li>
							<li class="nav-item">
 									 ...
 									 <div class="modal-dialog modal-dialog-centered" role="document">
    									<div class="modal-content">
      										<div class="modal-header">
        										<h5 class="modal-title" id="exampleModalCenterTitle">Calculate Monthly Expenses</h5>
        										<button type="button" class="close" data-dismiss="modal" aria-label="Close">
          										<span aria-hidden="true">&times;</span>
        										</button>
      										</div>
     									 <div class="modal-body">
      									  <form method="post" action="saveExpensesServlet">
  											<div class="form-row">
  											...
  											<div class="form-row">
    											<div class="col-md-12 mb-3">
     												 <label for="validationServer03">Description</label>
      												 <input type="text" class="form-control is-invalid" id="validationServer03" name="des" placeholder="Description" required>
							 ...
							 <table class="table table-dark">
									...
									<%
											try{
												...
												String sql ="SELECT* from monthlyexpenses";
								...
								<tbody>
									<tr>
									<td><%=resultset.getInt("expenseID") %></td>
