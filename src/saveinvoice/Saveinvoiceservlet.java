	...
	{ 
		try { 
			...
			PreparedStatement st = con 
				.prepareStatement("insert into neworder(customername,mobilenumber,medname,quan,gram,date)values(?,?,?,?,?,?)"); 
			...
			st.setString(4, String.valueOf(request.getParameter("quantity"))); 
